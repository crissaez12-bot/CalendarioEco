...
export const DATA: Record<Timeframe, AssetRow[]> = {
  '1h': [
    ...
    { name: 'XRP', ticker: 'XRP', tier: 2, price: 1.09, basis: 1.095, upper: 1.135, lower: 1.055, signal: 'bull', osc: 49.5, oscConfirm: true, atr: 0.39, updated: '08:14:11' },
    { name: 'BNB', ticker: 'BNB', tier: 2, price: 573.12, basis: 578.4, upper: 596.2, lower: 560.3, signal: 'none', osc: 44.0, oscConfirm: false, atr: 0.33, updated: '08:14:12' },
    { name: 'Cardano', ticker: 'ADA', tier: 2, price: 0.16, basis: 0.162, upper: 0.168, lower: 0.156, signal: 'bear', osc: 57.2, oscConfirm: true, atr: 0.45, updated: '08:14:13' },
    ...
    { name: 'Pepe', ticker: 'PEPE', tier: 1, price: 0.002918, basis: 0.002898, upper: 0.003014, lower: 0.002782, signal: 'none', osc: 59.0, oscConfirm: true, atr: 0.55, updated: '08:14:16' },
    { name: 'Ethereum Classic', ticker: 'ETC', tier: 2, price: 6.9060, basis: 6.9474, upper: 7.1836, lower: 6.7112, signal: 'bear', osc: 54.0, oscConfirm: true, atr: 0.26, updated: '08:14:17' },
  ...
  '15m': [
    ...
    { name: 'Cardano', ticker: 'ADA', tier: 2, price: 0.1598, basis: 0.1601, upper: 0.1615, lower: 0.1587, signal: 'none', osc: 48.5, oscConfirm: false, atr: 0.09, updated: '08:14:43' },
    ...
    { name: 'Ethereum Classic', ticker: 'ETC', tier: 2, price: 6.9080, basis: 6.8735, upper: 7.0041, lower: 6.7429, signal: 'bull', osc: 64.0, oscConfirm: false, atr: 0.18, updated: '08:44:16' },
  ],
}
